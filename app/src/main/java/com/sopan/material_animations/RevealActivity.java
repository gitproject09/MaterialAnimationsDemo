...
import com.sopan.material_animations.databinding.ActivityRevealBinding;
...
public class RevealActivity extends BaseDetailActivity implements View.OnTouchListener {
    ...
    private void revealBlue() {
        ...
        body.setTextColor(getResources().getColor(R.color.theme_blue_background));
    }
    ...
    private void revealRed() {
        ...
        transition.addListener(new Transition.TransitionListener() {
            ...
            public void onTransitionEnd(Transition transition) {
                ...
                body.setTextColor(getResources().getColor(R.color.theme_red_background));
    ...
    private void revealYellow(float x, float y) {
        ...
        body.setTextColor(getResources().getColor(R.color.theme_yellow_background));
    }

    private void revealGreen() {
        animateRevealColor(bgViewGroup, R.color.sample_green);
        body.setText(R.string.reveal_body2);
        body.setTextColor(getResources().getColor(R.color.theme_green_background));
    }
