...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupSamples() {
        samples = Arrays.asList(
                ...
                new Sample(getResources().getColor(R.color.sample_red), "Transitions"),
                new Sample(getResources().getColor(R.color.sample_blue), "Shared Elements"),
                new Sample(getResources().getColor(R.color.sample_green), "View animations"),
                new Sample(getResources().getColor(R.color.sample_yellow), "Circular Reveal Animation")
        );
    }
